...
//	$query_pms_delete = "DELETE FROM #__ujumbe WHERE fromid='" . (int) $userid ."' OR toid='" . (int) $userid . "'";

	// delete all messages send from this user and trashed from the outbox
	$query_pms_delete1 = "UPDATE #__ujumbe SET totrashoutbox=1, totrashdateoutbox=".$rightnow." WHERE fromid='" . (int) $userid . "'";
	// delete all messages recived by this user and trashed from the inbox
	$query_pms_delete2 = "UPDATE #__ujumbe SET totrash=1, totrashdate=".$rightnow." WHERE toid='".(int) $userid . "'";

	$query_pms_delete_extra1 = "DELETE FROM #__ujumbe_emn WHERE userid='" . (int) $userid . "'";
	$query_pms_delete_extra2 = "DELETE FROM #__ujumbe_blocks WHERE blocker='" . (int) $userid . "' OR blocked='" . (int) $userid . "'";
	$query_pms_delete_extra3 = "DELETE FROM #__ujumbe_userlists WHERE userid='" . (int) $userid ."'";
